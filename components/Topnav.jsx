        ...
        <>
            <header className="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
                <div
                    ...
                    {/* <!-- Mobile hamburger --> @click="toggleSideMenu" */}
                    ...
                    <ul className="flex items-center flex-shrink-0 space-x-6">
                        {/* <!-- Theme toggler -->  @click="toggleTheme" */}
                        <li className="flex">
                        ...
                        {/* <!-- Notifications menu -->   @click="toggleNotificationsMenu" @keydown.escape="closeNotificationsMenu"*/}
